...
{   
    ...
    loadFrame();
    ui-> frameLabel->setPixmap(image1);
...
void MainWindow::processWeatherJson(QJsonObject *json)
{
    ...
    ui->weatherLabel->setText("Condition: " + weather + ",  Temperature: " + QString::number(temp));
...
void MainWindow::loadFrame() {
    ...
    QString firstImage= ":/1.jpg";

    if (image1.load(firstImage)) {
        std::cout<< "Image loaded";
        image1= image1.scaled(ui-> frameLabel->size(), Qt::KeepAspectRatioByExpanding);
    }
}



void MainWindow::on_actionTo_Do_List_triggered()
{

    QString fileName= QFileDialog::getOpenFileName(this,
        tr("View To Do List"), "",
        tr("To Do (*csv);;All Files (*)"));
